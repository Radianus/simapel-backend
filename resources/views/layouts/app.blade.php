...
<body class="font-sans antialiased bg-gray-50 text-gray-700">
    ...
    <div x-data="{ sidebarOpen: window.innerWidth >= 768 }" @resize.window="sidebarOpen = window.innerWidth >= 768"
        ...
        <div :class="{ 'md:ml-0': !sidebarOpen && window.innerWidth >= 768, 'md:ml-64': sidebarOpen }"
            class="flex-1 flex flex-col transition-all duration-300 ease-in-out bg-white shadow-inner">

            <!-- Top Navbar -->
            <nav
                class="bg-white border-b border-gray-200 flex justify-between items-center px-4 py-3 sticky top-0 z-20 shadow-sm">
                ...
                <div class="ml-auto">
                    @auth
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button
                                    class="inline-flex items-center px-3 py-2 border border-transparent text-sm font-medium rounded-md text-gray-700 bg-white hover:text-blue-600 transition">
